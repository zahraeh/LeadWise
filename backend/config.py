...
CONFIGS = {
    "banking": {
        ...
        "lead_fields": [
            {"key": "age", "label": "Âge", "type": "number", "min": 18, "max": 100, "default": 30},
            ...
            {"key": "digital_score", "label": "Score digital (1–5)", "type": "number", "min": 1, "max": 5, "default": 3},
        ],
        "scoring_context": (
    ...
    "travel": {
        ...
        "lead_fields": [
            {"key": "age", "label": "Âge", "type": "number", "min": 18, "max": 100, "default": 25},
            ...
            {"key": "duration_weeks", "label": "Durée souhaitée (semaines)", "type": "number", "min": 1, "max": 52, "default": 2},
